...
- (void)setupSendButtonAndCancelButton {
    ...
    UIButton *sendBtn = [self buttonWithFrame:CGRectMake(self.cw_width / 2.0, self.cw_height - height, self.cw_width / 2.0, height) title:@"上传" titleColor:kSelectBackGroudColor font:[UIFont systemFontOfSize:18] backImageNor:@"aio_record_send_button" backImageHighled:@"aio_record_send_button_press" sel:@selector(btnClick:)];
...
//    NSLog(@"%@",btn.titleLabel.text);
    ...
    if (btn == self.sendButton) { // 发送
        ...
        NSLog(@"base64....%@",[self mp3ToBASE64:[CWRecordModel shareInstance].path]);
...
- (NSString *)mp3ToBASE64:(NSString *)path{
